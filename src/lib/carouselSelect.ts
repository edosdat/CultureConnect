 ...
 * back to rows[0].
 *
 * Product lock: while browsing, pack rails never insert to the LEFT of the
 * painted list or the selected thumb. densify / requestMore / hydrate may
 * only append to the right.
 */
...
/**
 * Product lock: never insert keys to the LEFT of the already-painted rail.
 * Keep painted order (including the selected thumb); new densify /
 * requestMore / hydrate keys append on the right only.
 */
...
/** Positive = films were inserted on the selected thumb's left. Must stay 0. */
