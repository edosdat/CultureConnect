      ...
      >
        {SLOTS.map((slot) => (
          <li key={slot} className={top3CardFrameClass(count)}>
            <div className="flex h-full animate-pulse items-start overflow-hidden rounded-card border border-culture-soft bg-culture-surface">
              <div className={TOP3_RAIL_IMAGE_CLASS + ' bg-culture-sand/70'} />
